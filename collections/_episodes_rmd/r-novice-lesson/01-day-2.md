...
release of 4.0.0
\[<a href="https://stat.ethz.ch/pipermail/r-announce/2020/000653.html" class="uri">https://stat.ethz.ch/pipermail/r-announce/2020/000653.html</a>\].
...
![](01-day-2_files/figure-markdown_strict/unnamed-chunk-10-1.png)
...
> #### Factors
>
> -   <s>Describe what a factor is.</s>
> -   <s>Convert between strings and factors.</s>
> -   <s>Reorder and rename factors.</s>
> -   <s>Change how character strings are handled in a data frame.</s>
>
> #### Tidyverse
>
> -   Describe the purpose of the **`dplyr`** and **`tidyr`** packages.
...
>         )
>
> 1.  What was the heaviest animal measured in each year? Return the
...
>
> 1.  Now take that data frame and `pivot_longer()` it again, so each
...
>
> 1.  The `surveys` data set has two measurement columns:
...
>
> 1.  With this new data set, calculate the average of each
...
Page built on: 📆 2022-01-05 ‒ 🕢 11:58:05
</p>
